...
export async function generateMetadata({
  ...
  return buildPageMetadata({
    title: tag.seoTitle || t("tagTitle", { name: tag.name }),
    description:
      tag.seoDescription || t("tagDescription", { name: tag.name }),
    path: `/tags/${slug}`,
    locale,
  });
}
...
export default async function TagDetailPage({
  ...
  const collectionPageJsonLd = tag
    ? {
        "@context": "https://schema.org",
        "@type": "CollectionPage",
        name: tag.name,
